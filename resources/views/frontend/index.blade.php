									...
									<div class="col-sm-3">
										<div class="single-item">
											<div class="single-item-header">
												<a href=""><img src="images/products/{{ $product->image }}" alt="{{ $product->image }}" style="width:260px;height: 220px"></a>
											</div>
											...
											<div class="single-item-caption">
												<a class="add-to-cart pull-left" href="{{ route('home.shopping') }}"><i class="fa fa-shopping-cart"></i></a>
